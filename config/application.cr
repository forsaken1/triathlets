...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Tri web application."
  #
  #
  ...
  #
  # settings.secret_key_base= MnLmXaubmDpxip-bB-_HlKWszlBWfBL7dkk8xtsZLJI
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("tri.log", "w"))
  #
  #
end
