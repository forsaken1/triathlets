...
USERS = {
  ...
  "Филитович Дмитрий"      => User.create(name: "Филитович Дмитрий").id,
  ...
  "Бобылев Михаил"         => User.create(name: "Бобылев Михаил").id,
  "Гатауллин Андрей"       => User.create(name: "Гатауллин Андрей", year: 1970).id,
  "Маликов Алексей"        => User.create(name: "Маликов Алексей").id,
  "Литвинов Алексей"       => User.create(name: "Литвинов Алексей").id,
  ...
  "Якимов Кирилл"          => User.create(name: "Якимов Кирилл").id,
